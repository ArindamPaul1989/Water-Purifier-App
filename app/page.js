          ...
          <button
            ...
            onClick={() => {
              ...
              if (frequency === 'Once a year' || frequency === 'Multiple times a year') {
                setStep(8.1); // Goes to taste consistency question
              } else {
                setStep(9); // Goes to final recommendation
              }
            }}
            className="block w-full text-left px-4 py-2 rounded hover:bg-blue-50 border mb-2"
          >
...
{/* Step 8.1: Taste Consistency Preference (for frequent movers) */}
{step === 8.1 && (
  <div className="max-w-2xl">
      ...
      {(() => {
        ...
        return (
          <div>
            ...
            <p>Based on your requirements, we recommend a standard RO purifier that will effectively treat your water.</p>
          </div>
        );
      })()}
